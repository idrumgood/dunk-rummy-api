...
exports.generateGameSummary = void 0;
const genai_1 = require("@google/genai");
const generateGameSummary = async (params) => {
    const { p1Name, p2Name, calculatedFinalResult, handsLength, targetScore, handWinBonus, gamesBetweenPlayersHistory, currentWinStreak, shutout, headToHeadP1Wins, headToHeadP2Wins, } = params;
    try {
...
exports.generateGameSummary = generateGameSummary;
